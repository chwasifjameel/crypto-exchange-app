...
export default function Dashabord() {
  ...
  return (
    <Layout>
      <main className="bg-[#F8F8F8] h-max px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex ml-0 md:ml-3 mt-3 md:mt-0">
              <div className="bg-blue-100 rounded-full">
                <div className="flex items-center mx-1">
                  <FaEthereum className="bg-blue-100" color="#6C6C6C" /> <p>ETH</p>
                  <div className="bg-blue-200 rounded-full ml-2 -mr-1 px-4 py-2">0xBAD7...E116</div>
                </div>
              </div>
